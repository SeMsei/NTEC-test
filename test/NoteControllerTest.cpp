...
void NoteControllerTest::onRun() {
    ...
    runner.run([this, &runner] {
        ...
        dto->phone_number = "1234";
        dto->id = 1;

        dto1->name = "name";
        dto1->address = "some address";
        dto1->phone_number = "12345";
        dto1->id = 2;

        dto2->name = "name";
        dto2->address = "some address";
        dto2->phone_number = "12346";
        dto2->id = 2;

        dto3->name = "name";
        dto3->address = "some address";
        dto3->phone_number = "1234";
        dto3->id = 3;

        dto4->name = "name";
        dto4->address = "some address";
        dto4->phone_number = "1234";
        dto4->id = 3;
